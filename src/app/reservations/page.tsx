...
import { Clock, Phone, MapPin, Mail, Star } from "lucide-react";
...
export default function ReservationsPage() {
  ...
  return (
    <div className="relative bg-[#050505] selection:bg-gold/30 min-h-screen overflow-x-hidden text-whitesmoke font-light pt-32 pb-32">
      ...
      <div className="ambient-glow w-[60vw] h-[60vh] top-0 left-0 opacity-15" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 md:mb-32">
          ...
          >
            ...
            <span className="text-gold font-medium tracking-[0.4em] text-[9px] uppercase">Exclusive Access</span>
            <span className="h-px w-8 bg-gold" />
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            Reserve Your <span className="italic text-white/80">Sanctuary</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Secure your spot for an unforgettable dining experience. For private events or parties larger than 12, please contact our concierge directly.
          </motion.p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 lg:gap-24 max-w-7xl mx-auto">
          
          {/* Form */}
          <motion.div 
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            className="lg:col-span-3 bg-luxury-glass p-8 md:p-14 rounded-sm border border-white/5 premium-shadow relative overflow-hidden min-h-[500px] flex items-center"
          >
            ...
            <AnimatePresence mode="wait">
              {!isBookingSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-4xl md:text-5xl font-heading text-white mb-6">Request Received</h3>
                  <p className="text-white/50 text-[14px] leading-relaxed max-w-sm mx-auto mb-10">
          ...
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            className="lg:col-span-2 space-y-16 mt-12 lg:mt-0"
          >
            <div className="space-y-12">
              <div className="border-l border-gold/30 pl-6 md:pl-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center border border-white/10 mt-1 shrink-0">
                      <Phone className="text-gold" size={12} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center border border-white/10 mt-1 shrink-0">
                      <Mail className="text-gold" size={12} />
                    </div>
                    <div>
              ...
              <div className="border-l border-white/20 pl-6 md:pl-8">
                ...
                <div className="space-y-5 text-sm text-white/50 font-light">
